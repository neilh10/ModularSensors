 ...
 * work for essentially any breakout of the Espressif rpcWifiRTL8720 wifi chip or ESP32
 * wifi/bluetooth chip that has been flashed with Espressif's AT command
 * firmware.
 */
/* clang-format off */
/**
 * @defgroup modem_rpcWifiRTL8720 Espressif rpcWifiRTL8720 and ESP32
 *
 * @ingroup the_modems
 *
 * @tableofcontents
 * @m_footernavigation
 *
 * @section modem_rpcWifiRTL8720_notes Introduction
 *
 * This is a circuit part of the Wio Terminal - description is a WIP (work In Progress)
 * It is communicated to with
 * RTL8720DTXD    UART_LOG_TXD
 * RTL8720D_RXD   UART_LOG_RXD
 * controlled with
 * PWR_EN turns on  VCC3V3_8720
 * RTL8720D_CHIP_PU  CHIP_EN
 * 
 * and
 * RTL8720_HSPI   _MOSI _MISO _CS _CLK
 * SYNC
 * IRQ0
 * 
 ...
 * TESTING:  tbd
 *
 * @section modem_rpcWifiRTL8720_dfrobot DFRobot ESPBee
 *
 ...
 *
 * @section modem_rpcWifiRTL8720_ctor Modem Constructor
 * {{ @ref WioTerminal_rpcwifi::WioTerminal_rpcwifi }}
 *
 * ___
 * @section modem_rpcWifiRTL8720_examples Example Code
 ...
 *
 * @menusnip{espressif_rpcWifiRTL8720}
 */
/* clang-format on */


// Header Guards
#ifndef SRC_MODEMS_WIOTERMINAL_RPCWIFI_H_
#define SRC_MODEMS_WIOTERMINAL_RPCWIFI_H_

// Debugging Statement
// #define MS_WIOTERMINAL_RPCWIFI_DEBUG
// #define MS_WIOTERMINAL_RPCWIFI_DEBUG_DEEP
 ...
 * possible.**
 */
#define ESP8266update_STATUS_LEVEL HIGH
/**
 * @brief The loggerModem::_statusTime_ms.
 * @copydetails #ESP8266_STATUS_LEVEL
 */
#define ESP8266update_STATUS_TIME_MS 350
 ...
 */
#define ESP8266update_RESET_LEVEL LOW
/**
 * @brief The loggerModem::_resetPulse_ms.
 * @copydetails #ESP8266_RESET_LEVEL
 */
#define ESP8266update_RESET_PULSE_MS 1
 ...
 */
#define ESP8266update_WAKE_LEVEL LOW
/**
 * @brief The loggerModem::_wakePulse_ms.
 * @copydetails #ESP8266_WAKE_LEVEL
 */
#define ESP8266update_WAKE_PULSE_MS 0
 ...
 */
#define ESP8266update_WAKE_DELAY_MS 0
/**
 ...
 */
#define ESP8266update_ATRESPONSE_TIME_MS 700
 ...
 */
#define ESP8266update_DISCONNECT_TIME_MS 500
 ...
 * all).
 */
class WioTerminal_rpcwifi : public loggerModem {
 public:
    // Constructor/Destructor
    /**
     * @brief Construct a new Espressif rpcWifiRTL8720 object.
     *
     ...
     * between the MCU and the rpcWifiRTL8720.
     *
