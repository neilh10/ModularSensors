/**
 * @file AnalogElecConductivityM.h
...
// Header Guards
#ifndef SRC_SENSORS_ANALOGELECCONDUCTIVITYM_H_
#define SRC_SENSORS_ANALOGELECCONDUCTIVITYM_H_

#ifdef MS_ANALOGELECCONDUCTIVITY_DEBUG
#define MS_DEBUGGING_STD "AnalogElecConductivityM"
#endif
#ifdef MS_ANALOGELECCONDUCTIVITY_DEBUG_DEEP
#define MS_DEBUGGING_DEEP "AnalogElecConductivityM"
#endif
 ...
 * @ingroup sensor_analog_cond
 */
class AnalogElecConductivityM : public Sensor {
 public:
    /**
     * @brief Construct a new AnalogElecConductivityM object.
     *
     ...
     */
    AnalogElecConductivityM(int8_t powerPin, int8_t dataPin,
                            float   Rseries_ohms          = RSERIES_OHMS_DEF,
                            float   sensorEC_Konst        = SENSOREC_KONST_DEF,
                            uint8_t measurementsToAverage = 1);

    /**
     * @brief Destroy the AnalogElecConductivityM object - no action needed.
     */
    ~AnalogElecConductivityM();
 ...
 *
 */
class AnalogElecConductivityM_EC : public Variable {
 public:
    /**
     * @brief Construct a new  AnalogElecConductivityM_EC object.
     *
     * @param parentSense The parent AnalogElecConductivityM providing the
     * result values.
     ...
     */
    AnalogElecConductivityM_EC(
        AnalogElecConductivityM* parentSense, const char* uuid = "",
    ...
    /**
     * @brief Destroy the AnalogElecConductivityM_EC object - no action needed.
     */
    ~AnalogElecConductivityM_EC() {}
};
/**@}*/
#endif  // SRC_SENSORS_ANALOGELECCONDUCTIVITYM_H_
