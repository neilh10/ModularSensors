 ...
 * Temperature from thermistor, Requires: adcPin, Source Resistance, thermistor
 type,
 *
 *
 * By default all sensors defined are measured.
 * The sensors not used can be turned off so that they cause minimal runtime
 impacts.
 * The downside of this module is that all sensors are defined and take code,
 irrespective of if they actually exist
 *
 */
...
//#define ANALOGTHERMISTOR_POLLMASK_ALL
//(ANALOGTHERMISTOR_POLLMASK_A|ANALOGTHERMISTOR_POLLMASK_V|ANALOGTHERMISTOR_POLLMASK_W)
//#define ANALOGTHERMISTOR_POLLMASK_ALL
//(ANALOGTHERMISTOR_POLLMASK_EC|ANALOGTHERMISTOR_POLLMASK_TEMPERATURE)
